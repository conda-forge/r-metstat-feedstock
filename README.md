...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/r-metstat-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=8006&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/r-metstat-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `r-metstat` can be installed with:

```
conda install r-metstat
```

It is possible to list all of the versions of `r-metstat` available on your platform with:
